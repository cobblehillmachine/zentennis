...
if ( $attachment_ids ) {
	...
	?>
	<div class="thumbnails desktop <?php echo 'columns-' . $columns; ?>"><?php
		...
		foreach ( $attachment_ids as $attachment_id ) {
			...
			echo apply_filters( 'woocommerce_single_product_image_thumbnail_html', sprintf( '<a >%s</a>', $image ), $attachment_id, $post->ID, $image_class );
	...
	<div class="single-product flexslider mobile">
		<ul class="slides">
