...
<div class="customer-details">
	...
	<?php
		if ( $order->billing_email ) {
			echo '<div><span>' . __( 'Email:', 'woocommerce' ) . '</span><span data-title="' . __( 'Email', 'woocommerce' ) . '">' . $order->billing_email . '</span></div>';
		}
	
		if ( $order->billing_phone ) {
			echo '<div><span>' . __( 'Telephone:', 'woocommerce' ) . '</span><span data-title="' . __( 'Telephone', 'woocommerce' ) . '">' . $order->billing_phone . '</span></div>';
		}
